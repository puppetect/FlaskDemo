...
from flaskdemo import app, db, bcrypt, mail
from flaskdemo.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with constructions to reset your password', 'info')
